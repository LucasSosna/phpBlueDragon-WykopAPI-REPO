...
<head>
    ...
    /*
    <script type="text/javascript" src="<?php echo $UrlOfPage; ?>library/slimbox/js/slimbox2.js"></script>
    <link rel="stylesheet" href="<?php echo $UrlOfPage; ?>library/slimbox/css/slimbox2.css" type="text/css" media="screen" />
    */
    ?>
   <meta charset="utf-8">
   ...
   <script src="<?php echo $UrlOfPage; ?>library/bootstrap.min.js" type="text/javascript"></script>
   <link href="<?php echo $UrlOfPage; ?>library/lightbox2/dist/css/lightbox.css" rel="stylesheet" />
   <script src="<?php echo $UrlOfPage; ?>library/lightbox2/dist/js/lightbox.js"></script>
   <script src="<?php echo $UrlOfPage; ?>library/jquery.selection.js"></script>
   
   <script src="<?php echo $UrlOfPage; ?>library/jquery-ui.min.js"></script>
   <link href="<?php echo $UrlOfPage; ?>library/jquery-ui.css" rel="stylesheet" />
    
   <link href="<?php echo $UrlOfPage; ?>library/jquery-ui-timepicker-addon.css" rel="stylesheet" />
   <script src="<?php echo $UrlOfPage; ?>library/jquery-ui-timepicker-addon.js"></script>
...
<div class="container" style="margin-top: 5px;">
    <div class="header" style="padding-top: 7px;">
        <div style="float: left;"><a href="<?php echo $UrlOfPage; ?>" title="phpBlueDragon WykopAPI"><img src="<?php echo $UrlOfPage; ?>wykopapi.png" width="35" height="35" /></a></div>
        <div style="float: left;">&nbsp;&nbsp;</div>
        <div style="float: left; margin-top: 4px;"><a href="<?php echo $UrlOfPage; ?>" style="font-weight: normal; font-size: 20px; text-decoration: none; color: #1c87a8;">PBD WykopAPI</a></div>
    </div>
    <div class="menu">
        <div id="cssmenu">
        <ul>
