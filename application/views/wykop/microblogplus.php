...
echo form_open('microblogplus');

$OptionWhat['plus'] = ''.$this->lang->line('a1131').'';
$OptionWhat['minus'] = ''.$this->lang->line('a1132').'';

/*
echo '<strong>Dla znaleziska:</strong> <br /> '.form_dropdown('add_what', $OptionWhat, $Vadd_what, 'class="form-control"').'<br />';
echo form_error('add_what','<div class="alert alert-danger">','</div>');
*/

echo form_hidden('formlogin','yes');
echo form_submit(array('name' => 'buttonstart', 'value' => ''.$this->lang->line('a1146').'', 'class' => 'btn btn-info btn-block'));
echo form_close();
