...
// GitHubProjects/phpBlueDragonWykopAPI/
...
$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]access (
  access_id int(11) NOT NULL AUTO_INCREMENT,
  access_key varchar(25) NOT NULL,
  access_secret varchar(25) NOT NULL,
  access_connection varchar(25) NOT NULL,
  access_check datetime NOT NULL,
...
(5, 'foot', 'Copyright &copy; <a href=\"http://phpbluedragon.eu\">phpBlueDragon WykopApi</a>');";

$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]cron (
  cron_id int(11) NOT NULL AUTO_INCREMENT,
  cron_top varchar(15) CHARACTER SET utf8 NOT NULL,
  cron_dig varchar(15) CHARACTER SET utf8 NOT NULL,
  cron_microblog varchar(15) CHARACTER SET utf8 NOT NULL,
  cron_comm_top varchar(15) CHARACTER SET utf8 NOT NULL,
  cron_comm_howmany_top int(11) NOT NULL,
  cron_comm_dig varchar(15) CHARACTER SET utf8 NOT NULL,
  cron_comm_howmany_dig int(11) NOT NULL,
  cron_start varchar(10) NOT NULL,
  cron_stop varchar(10) NOT NULL,
  PRIMARY KEY (cron_id)
) ENGINE=InnoDB  DEFAULT CHARSET=latin2 AUTO_INCREMENT=2;";

$SqlQuert[] = "INSERT INTO [DBPREFIX]cron (cron_id, cron_top, cron_dig, cron_microblog, cron_comm_top, cron_comm_howmany_top, cron_comm_dig, cron_comm_howmany_dig, cron_start, cron_stop) VALUES
(1, 'noaction', 'noaction', 'noaction', 'noaction', 1, 'noaction', 1, '01:00:00', '23:00:00');";

$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]cron_date (
  date_id int(11) NOT NULL AUTO_INCREMENT,
  date_when varchar(10) NOT NULL,
  date_when_read datetime NOT NULL,
  date_what varchar(15) NOT NULL,
  date_maked char(1) NOT NULL,
  PRIMARY KEY (date_id)
...
{
    $SqlQuert[] = "INSERT INTO [DBPREFIX]email (email_id, email_title, email_content, email_what, email_desc) VALUES
    (2, 'Password reminder on the site phpBlueDragon WykopApi', 'Good morning,\n\nYou requested a password reminder. To do this, click on the link: \n[change_password]\n\nRequest reminder was sent: [user_date]\nComputer with the IP: [user_ip] ','recpassword',' [change_password] - link to change your password\r\n[user_date] - the date of sending\r\n[user_ip] - computer IP'),
	(3, 'Your password has been changed on the site phpBlueDragon WykopApi', 'The new password to the site:\n\n[new_password]\n\nNew password was generated: [user_date]\nPC IP: [user_ip]','newpass','[new_password] - password to the site\r\n[user_date] - the date of sending\r\n[user_ip] - computer IP'),
    (5, 'The report link checker phpBlueDragon WykopApi', '[user_content]', 'report', '[user_content] - content of the report');";
}

$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]entry_cron (
  entry_id int(11) NOT NULL AUTO_INCREMENT,
  entry_comment text CHARACTER SET utf8 NOT NULL,
  entry_file varchar(255) NOT NULL,
  entry_time varchar(15) NOT NULL,
  entry_maked char(1) NOT NULL,
...
$SqlQuert[] = "CREATE TABLE IF NOT EXISTS [DBPREFIX]session (
  session_id int(11) NOT NULL AUTO_INCREMENT,
  session_ident varchar(255) NOT NULL,
  session_key varchar(50) NOT NULL,
  session_secret varchar(50) NOT NULL,
...
(1, '[USER_EMAIL]', '[USER_PASSWORD]', 'jiwuy8e4vruikadc6b84');";
...
function GetLang($Line)
{
    if($_SESSION['language_install'] == 'polish')
    {
    	...
    	$lang['install_subbar'] = 'Instalator programu phpBlueDragon WykopApi';
    ...
    else
    {
        ...
        $lang['install_subbar'] = 'Setup phpBlueDragon WykopApi'; 
